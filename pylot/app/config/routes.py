...
"""
routes['default_controller'] = 'Requests'
routes['POST']['/Users/create'] ='Users#create'
routes['POST']['/login'] = 'Users#login'
routes['POST']['/Requests/add']='Requests#add'

# routes['/Users/home/<id>']='Users#home'
# routes['/Users/logout']='Users#logout'
# routes['/Users/show/<id>']='Users#show'
# routes['/Friendships/add/<user_id>/<friend_id>']='Friendships#add'
# routes['/Friendships/remove/<friendship_id>']='Friendships#remove'
"""
